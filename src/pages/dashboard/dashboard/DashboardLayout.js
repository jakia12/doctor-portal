...
const DashboardLayout = () => {
    ...
    return (
        <div>
            <Header />
            <section className="dashboard_section py-14 lg:py-20 relative">
                <div className="container mx-auto w-full lg:max-w-7xl px-6">

                    <div className="md:flex">
                        <div className="w-3/12 lg:block hidden">
                            <div id="drawer-navigation" className="mr-3 shadow-lg shadow-gray-100 z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
                                <div className="py-4 overflow-y-auto">
                                    <ul className="space-y-2">
                                        ...
                                        <li>
                                            <Link to="/dashboard/manageDoctors" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                                <svg aria-hidden="true" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
                                                <span className="ml-3">Manage Doctor</span>
                                            </Link>
                                        </li>
